...
// Отримайте максимальну та мінімальну температуру
    ...
    computed: {
        ...
        //     fetch(url)
        //     .then(data => data.json())
        //     .then(json => new_items(json));

        //     function new_items(json) {
        //         for (let i = 0; i <= 10; i++) {
                    
        //             this.new_title=json.articles.results[i].title;
